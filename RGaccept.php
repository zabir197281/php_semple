...
$sq2=" update request  set   Buy_request='sold'  where  PropertyID= ".$_GET["d"]." and renttakerUsername='".$_GET["u"]."'  " ;

$result2 = mysqli_query($connect,$sq2) or die  ( mysqli_error($connect)  );

$sql3=" delete from request where PropertyID= ".$_GET["d"]." and Buy_request='pending' " ;

$result3 = mysqli_query($connect,$sql3) or die  ( mysqli_error($connect)  );



header("Location:seerentRequest.php");
